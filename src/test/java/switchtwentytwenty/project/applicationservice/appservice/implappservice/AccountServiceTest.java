...
import switchtwentytwenty.project.domain.aggregate.account.CreditAccount;
...
class AccountServiceTest {
    ...
    void getCashAccountBalanceWhenIamNotTheAdmin_Invalid() throws Exception {
        //arrange
        String adminId = "admin@gmail.com";
        AccountID accountID = new AccountID(UUID.randomUUID());
        CashAccount cashAccount = Mockito.mock(CashAccount.class);
        ...
        //act - assert
        assertThrows(IllegalArgumentException.class, () -> service.getCashAccountBalance(adminId,accountID.toString()));
    }

    @Test
    @DisplayName("get cash account balance when i am not a user - unsuccessful case")
    void getCashAccountBalance_InvalidPerson() throws Exception {
        //arrange
        String adminId = "admin@gmail.com";
        AccountID accountID = new AccountID(UUID.randomUUID());
        CashAccount cashAccount = Mockito.mock(CashAccount.class);
        ...
        //act - assert
        assertThrows(ElementNotFoundException.class, () -> service.getCashAccountBalance(adminId,accountID.toString()));
    }


    @Test
    @DisplayName("get cash account balance for invalid account - unsuccessful case")
    void getCashAccountBalance_InvalidAccount() throws Exception {
        //arrange
        String adminId = "admin@gmail.com";
        AccountID accountID = new AccountID(UUID.randomUUID());
    ...
    @Test
    @DisplayName("get account balance from a non cash account- unsuccessful case")
    void getBalanceFormANonCashAccount() throws Exception {
        //arrange
        String adminId = "admin@gmail.com";
        AccountID accountID = new AccountID(UUID.randomUUID());
        CreditAccount account = Mockito.mock(CreditAccount.class);
        when(accountRepository.findByID(Mockito.any(AccountID.class))).thenReturn(account);
        when(account.getAccountType()).thenReturn(Constants.CREDIT_ACCOUNT_TYPE);
