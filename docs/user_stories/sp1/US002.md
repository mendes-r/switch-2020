...
participant ":GetStandard\nCategoriesTreeController" as controller
participant "categoryService:\nCategoryService" as service
participant "categoryTreeOutDTOList:\nList<CategoryTreeOutDTO>" as tree
participant ":categoryTreeOutDTO" as dto
...
opt 
  alt ParentID==null
  service -> dto **:create
  service -> service :construct tree()
  service -> tree :add()
  end
end 
service --> controller :categoryTreeOutDTOList
deactivate service
deactivate controller
[<--o controller :categoryTreeOutDTOList
```
